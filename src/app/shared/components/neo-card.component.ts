...
@Component({
  ...
  styles: [`
    ...
    .neo-count { font-size: 0.875rem; color: var(--accent-cyan); font-family: var(--font-mono); }
    ...
    .neo-detail { font-size: 0.875rem; color: var(--text-tertiary); }
    .neo-distance { text-align: right; display: flex; flex-direction: column; gap: 2px; }
    .distance-value { font-family: var(--font-mono); font-size: 0.875rem; font-weight: 600; }
    .distance-label { font-size: 0.875rem; color: var(--text-tertiary); }
    .safe { color: var(--status-safe); }
    .watch { color: var(--status-warn); }
    .danger { color: var(--status-danger); }
    .neo-more { font-size: 0.875rem; color: var(--text-tertiary); text-align: center; }
  `],
})
